...
public class List_librarian extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					List_librarian frame = new List_librarian();
	...
	public List_librarian() {
		...
		JLabel lblNewLabel = new JLabel("List Of Librarians");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Id", "Name Of Librarian", "User Id"
			}
		));
		int h ;
		try {
			PreparedStatement pst = con.prepareStatement("SELECT * FROM libdetails");
